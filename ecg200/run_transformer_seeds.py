...
from harness.models.cnn import train_cnn, set_seed, torch_predict_proba, count_parameters
...
for seed in SEEDS:
    ...
    json.dump(out, open(BASE/'results'/'metrics'/'transformer_seeds.json','w'))
